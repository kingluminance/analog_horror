...
func _ready() -> void:
	...
	Stats.register_stat("hp", "HP", 1)
	Stats.register_stat("aggression", "공격성", 1)
	Stats.register_stat("flexibility", "유연성", 12.0)
	Stats.register_stat("level", "레벨", 1.0, 10.0, false) # no cap -- ordinary level growth
